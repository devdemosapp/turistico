...
class GestorVideos{
	...
	static public function mostrarVideoController($datos){
	...
	#------------------------------------------------------------
	static public function mostrarVideoVistaController(){
	...
	#ELIMINAR VIDEO
	#-----------------------------------------------------------
	static public function eliminarVideoController($datos){
