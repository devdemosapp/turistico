...
class GestorSlide{
	...
	static public function mostrarImagenVistaController(){
		...
		foreach($respuesta as $row => $item){
			...
			echo '<li id="'.$item["id"].'" class="bloqueSlide"><span class="fa fa-times eliminarSlide" ruta="'.$item["ruta"].'"></span><img src="'.substr($item["ruta"], 6).'" class="handleImg" height="150px" width="150px"></li>';
